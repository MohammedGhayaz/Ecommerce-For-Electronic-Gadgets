...
if(isset($_POST['update'])){
   ...
   $update_inventory->execute([$quantity, $pid]);
...
<input type="number" name="quantity" required class="box" min="0" max="999999" placeholder="enter product quantity" value="<?= $fetch_products['quantity']; ?>">
